...
INSERT INTO `lessons` (`title`, `description`, `content`, `start_date`, `created_at`, `updated_at`) VALUES ('National Scheduling Conflict Champsionships', 'Cancelled', 'Cancelled...', '2015-07-08', NULL, NULL);
